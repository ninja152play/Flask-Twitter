...
def create_app():
    ...
    media_ns = api.namespace("media", description="Just media")
    ...
    from .utils import get_user_by_key, get_list_tweets
    ...
    #                 "id": user.id,
    #                 "name": user.name,
    #                 "followers": [{"id": follower.follower_id, "name": follower.follower.user.name} for follower in followers],
    #                 "following": [{"id": following.follow_on_id, "name": following.follow_on.user.name} for following in followings],
    #             }
    #         }
